      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredSkills.map((sk, idx) => {
          ...
          return (
            <div
              key={idx}
              className="p-5 rounded-2xl glass-card border border-gray-200 dark:border-white/10 flex flex-col justify-between space-y-3"
            >
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-white/5">
                <button
                  ...
                  className="w-full py-2 rounded-xl text-xs font-bold bg-gray-100 dark:bg-white/5 hover:bg-brand-500/20 text-brand-300 hover:text-white border border-brand-500/30 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
