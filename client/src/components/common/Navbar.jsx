...
export default function Navbar({ onMobileMenuToggle, isMobileMenuOpen }) {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'Assessment Result Ready', desc: 'Your React 18 Benchmark score is 92%. +150 XP awarded!', time: '10m ago', unread: true },
    { id: 2, title: 'New Course Recommendation', desc: 'Added "High-Performance Node.js & MongoDB" to your path.', time: '1h ago', unread: true },
    { id: 3, title: 'Weekly Goal Sync', desc: 'You logged 7.5 of 12 hours this week. Keep going!', time: '1d ago', unread: true },
  ]);
