  ...
  return (
    <div className="space-y-6">
      <Card variant="glow" className="relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-gray-100 dark:bg-white/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col items-center text-center py-10 px-4 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 mb-3">
            ...
            <Badge variant="neutral" size="sm">
              <span className="flex items-center gap-1 font-mono">
                <GitBranch className="w-3 h-3 text-gray-500 dark:text-[#8C877D]" />
                {branchName}
              </span>
            </Badge>
          </div>
          ...
          {/* Title & Description */}
          <h2 className="text-xl md:text-2xl font-extrabold text-gray-900 dark:text-[#F5F1E8] mb-2">
            {title}
          </h2>
          <p className="text-xs sm:text-sm text-gray-600 dark:text-[#C7C2B6] mb-6 font-medium">
            {description}
          </p>

          {/* Planned Feature Scope */}
          {plannedFeatures.length > 0 && (
            <div className="w-full bg-white dark:bg-[#0B0D0F]/80 border border-gray-200 dark:border-white/[0.08] rounded-xl p-4 mb-6 text-left">
              <div className="flex items-center gap-2 mb-3 text-xs font-bold text-gray-900 dark:text-[#F5F1E8] uppercase tracking-wider">
                <Code2 className="w-4 h-4 text-[#FF6B5F]" />
                Feature Highlights:
              </div>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-gray-600 dark:text-[#C7C2B6]">
