  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in overflow-y-auto">
      <div className="bg-[#111418] rounded-[28px] max-w-2xl w-full shadow-2xl overflow-hidden my-8 border border-white/[0.1] text-[#F5F1E8] relative flex flex-col max-h-[90vh]">
        ...
        {/* Header */}
        <div className="p-6 border-b border-white/[0.08] bg-[#0E1114] flex items-start justify-between gap-4 shrink-0">
          <div className="space-y-1.5 flex-1">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-bold bg-white/5 text-[#C7C2B6] font-mono border border-white/10">
                {course.difficulty}
              </span>
            ...
            <h2 className="text-lg sm:text-xl font-black tracking-tight text-[#F5F1E8]">
              {course.title}
            </h2>
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-xl text-[#8C877D] hover:text-[#F5F1E8] hover:bg-white/10 transition-colors cursor-pointer shrink-0"
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          {/* Key Metrics Banner */}
          <div className="grid grid-cols-3 gap-3 p-3.5 rounded-2xl bg-[#16191E] border border-white/[0.06] text-center">
            <div>
              <span className="text-[10px] font-bold text-[#8C877D] uppercase block">Duration</span>
              <span className="text-xs sm:text-sm font-bold font-mono text-[#F5F1E8] flex items-center justify-center gap-1 mt-0.5">
                <Clock className="w-3.5 h-3.5 text-[#FF6B5F]" />
                {course.duration}
              </span>
            </div>
            <div>
              <span className="text-[10px] font-bold text-[#8C877D] uppercase block">Lessons</span>
              <span className="text-xs sm:text-sm font-bold font-mono text-[#F5F1E8] flex items-center justify-center gap-1 mt-0.5">
            ...
            <div>
              <span className="text-[10px] font-bold text-[#8C877D] uppercase block">Reward</span>
          ...
          {course.enrolled && (
            <div className="space-y-1.5 p-4 rounded-2xl bg-[#0E1114] border border-white/[0.06]">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C877D] font-medium">Curriculum Progress</span>
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-bold text-[#C7C2B6] uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {resources.officialDocs && (
                <a
                  ...
                  className="flex items-center justify-between p-3 rounded-xl bg-[#16191E] border border-white/[0.06] hover:border-[#FF6B5F]/40 transition-all group"
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="truncate">
                      <p className="text-xs font-bold text-[#F5F1E8] group-hover:text-[#FF857A] truncate transition-colors">
                        {resources.officialDocs.title}
                      </p>
                      <span className="text-[10px] text-[#8C877D]">Official Documentation</span>
                    </div>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-[#8C877D] group-hover:text-[#FF857A] shrink-0 ml-2" />
                </a>
              )}
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="truncate">
                      ...
                      <span className="text-[10px] text-[#8C877D]">Curated Video Tutorial</span>
                    </div>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-[#8C877D] group-hover:text-[#FF857A] shrink-0 ml-2" />
                </a>
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="truncate">
                      ...
                      <span className="text-[10px] text-[#8C877D]">Recommended Channel</span>
                    </div>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-[#8C877D] group-hover:text-[#FF857A] shrink-0 ml-2" />
                </a>
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="truncate">
                      ...
                      <span className="text-[10px] text-[#8C877D]">Interactive Lab / Website</span>
                    </div>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-[#8C877D] group-hover:text-[#FF857A] shrink-0 ml-2" />
                </a>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              {course.modules?.map((mod, idx) => (
                <div key={idx} className="rounded-xl bg-[#0E1114] border border-white/[0.06] p-3.5 space-y-2.5">
                  <div className="flex items-center justify-between text-xs font-bold text-[#F5F1E8]">
                    <span>{mod.title}</span>
                    <span className="text-[10px] text-[#8C877D] font-mono">{mod.duration}</span>
                  </div>
                  ...
                  <ul className="space-y-1.5">
                    {mod.lessons?.map((lesson) => (
                      <li
                        ...
                        className="flex items-center justify-between p-2 rounded-lg bg-[#111418] border border-white/[0.04] text-xs hover:border-[#FF6B5F]/30 cursor-pointer group transition-all"
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className={`${lesson.completed ? 'text-[#8C877D] line-through' : 'text-[#C7C2B6] group-hover:text-[#F5F1E8]'}`}>
                            {lesson.title}
                          </span>
                        </div>
                        <span className="text-[10px] text-[#8C877D] font-mono shrink-0 ml-2">
                          {lesson.duration}
                        </span>
                      </li>
                    ))}
        ...
        <div className="p-4 sm:p-6 border-t border-white/[0.08] bg-[#0E1114] flex flex-wrap items-center justify-between gap-3 shrink-0">
          <div className="flex items-center gap-2">
            {course.assessmentId && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl border border-white/10 text-xs font-bold text-[#C7C2B6] hover:text-[#F5F1E8] hover:bg-white/5 transition-all cursor-pointer flex items-center gap-1.5"
              >
