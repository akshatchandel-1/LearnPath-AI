    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card variant="interactive">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-gray-500 dark:text-[#8C877D] font-medium">Total Time Invested</span>
            <div className="w-8 h-8 rounded-xl bg-[#FF6B5F]/10 border border-[#FF6B5F]/20 text-[#FF6B5F] flex items-center justify-center">
              <Clock className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-black text-gray-900 dark:text-[#F5F1E8] tracking-tight font-mono">{userHours} Hours</div>
        ...
        <Card variant="interactive">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-gray-500 dark:text-[#8C877D] font-medium">Active Learning Streak</span>
          ...
          <div className="text-2xl font-black text-gray-900 dark:text-[#F5F1E8] tracking-tight font-mono">{userStreak} Days</div>
          <span className="text-[11px] text-gray-500 dark:text-[#8C877D] mt-1 block">
        ...
        <Card variant="interactive">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-gray-500 dark:text-[#8C877D] font-medium">Total XP Earned</span>
            <div className="w-8 h-8 rounded-xl bg-[#34D399]/10 border border-[#34D399]/20 text-[#34D399] flex items-center justify-center">
              <Award className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-black text-gray-900 dark:text-[#F5F1E8] tracking-tight font-mono">+{userXp} XP</div>
        ...
        <Card variant="interactive">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs text-gray-500 dark:text-[#8C877D] font-medium">Active Tracks</span>
            <div className="w-8 h-8 rounded-xl bg-[#38BDF8]/10 border border-[#38BDF8]/20 text-[#38BDF8] flex items-center justify-center">
              <BookOpen className="w-4 h-4" />
            </div>
          </div>
          <div className="text-2xl font-black text-gray-900 dark:text-[#F5F1E8] tracking-tight font-mono">{enrolledCourses.length}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card variant="glow" className="lg:col-span-2">
          <div className="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-white/[0.08] mb-4">
            <div>
              <CardTitle className="text-gray-900 dark:text-[#F5F1E8]">7-Day Study Cadence</CardTitle>
              <p className="text-xs text-gray-500 dark:text-[#8C877D]">Hours focused on curriculum lessons and code challenges</p>
            </div>
            ...
            {weeklyActivity.map((day, idx) => {
              ...
              return (
                <div key={idx} className="flex-1 flex flex-col items-center gap-2 group">
                  <span className="text-[10px] font-mono text-gray-500 dark:text-[#8C877D] opacity-0 group-hover:opacity-100 transition-opacity">
                    {day.hours}h
                  </span>
                  <div className="w-full bg-gray-100 dark:bg-white/5 rounded-xl h-40 flex items-end p-1 overflow-hidden">
                    <div
                  ...
                  <span className="text-xs font-bold text-gray-500 dark:text-[#8C877D] group-hover:text-gray-900 dark:hover:text-[#F5F1E8] transition-colors font-mono">
                    {day.day}
                  </span>
                </div>
              );
        ...
        <Card variant="default" className="space-y-4">
          <div className="flex items-center justify-between pb-2 border-b border-gray-200 dark:border-white/[0.06]">
            <CardTitle className="text-gray-900 dark:text-[#F5F1E8]">Domain Breakdown</CardTitle>
          ...
          <div className="space-y-3.5">
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-gray-600 dark:text-[#C7C2B6] font-semibold">Frontend & React</span>
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-gray-600 dark:text-[#C7C2B6] font-semibold">Backend & APIs</span>
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-gray-600 dark:text-[#C7C2B6] font-semibold">Databases & Indexing</span>
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-gray-600 dark:text-[#C7C2B6] font-semibold">DevOps & Cloud</span>
      ...
      <Card variant="default">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-bold text-gray-900 dark:text-[#F5F1E8]">Unlocked Milestones & Badges</h3>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-[#0E1114] border border-gray-200 dark:border-white/[0.06] flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-[#F5F1E8]">Architect Pioneer</h4>
              <span className="text-[10px] text-gray-500 dark:text-[#8C877D]">Joined platform</span>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-[#0E1114] border border-gray-200 dark:border-white/[0.06] flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-[#F5F1E8]">First Checkpoint</h4>
              <span className="text-[10px] text-gray-500 dark:text-[#8C877D]">Passed quiz</span>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-[#0E1114] border border-gray-200 dark:border-white/[0.06] flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-[#F5F1E8]">Curriculum Explorer</h4>
              <span className="text-[10px] text-gray-500 dark:text-[#8C877D]">Enrolled in track</span>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-[#0E1114] border border-gray-200 dark:border-white/[0.06] flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-[#F5F1E8]">Streak Flame</h4>
              <span className="text-[10px] text-gray-500 dark:text-[#8C877D]">Continuous focus</span>
            </div>
          </div>
        </div>
      </Card>
